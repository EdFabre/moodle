...
//-------------------------------------------------------------------------------
        ...
        if(isset($selectdropdown)) {
            foreach(array_keys($records) as $key) {
                if($selectdropdown->getSelected() === $key) {
            ...
            $mform->addElement('select','resourcetype',get_string('resourcetype','mediasite'),$resourcetypes,array('size'=>'1',
                                                                                                               'id' => 'id_resourcetype'));

...
function SCORM2004_Finish(strExitType, blnStatusWasSet){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.exit", SCORM_TranslateExitTypeToSCORM(strExitType));
...
function SCORM2004_RecordMultipleChoiceInteraction(strID, strResponse, blnCorrect, strCorrectResponse){
	
	var blnResult;
	var intInteractionIndex;
	var strResult;
	
	WriteToDebug("In SCORM2004_RecordMultipleChoiceInteraction strID=" + strID + ", strResponse=" + strResponse + ", blnCorrect=" + blnCorrect + ", strCorrectResponse=" + strCorrectResponse);
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".type", SCORM2004_INTERACTION_TYPE_CHOICE);
...
function SCORM2004_ResetStatus(){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.completion_status", SCORM2004_UNKNOWN);
